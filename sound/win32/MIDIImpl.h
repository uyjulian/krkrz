...
#else
	NativeEventQueue<tTJSNI_MIDISoundBuffer> EventQueue; // a dummy window for receiving status from playing thread
	void UtilWndProc( NativeEvent& ev ); // its window procedure
#endif
